...
public class TC_01AutomobileSilver {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("licenseplatenumber")).sendKeys("MH42AZ6168");
		...
		driver.findElement(By.id("firstname")).sendKeys("Devendra");
		driver.findElement(By.id("lastname")).sendKeys("Shaha");
		driver.findElement(By.id("birthdate")).sendKeys("10/30/1999");
		...
		driver.findElement(By.id("streetaddress")).sendKeys("Kacheri Road Baramati");
		...
		occu.selectByValue("Unemployed");
		
		driver.findElement(By.xpath("//label[normalize-space()='Speeding']")).click();
		
		driver.findElement(By.id("nextenterproductdata")).click();
		
		//Enter Product Data
		
		driver.findElement(By.id("startdate")).sendKeys("12/10/2023");
		...
		String expPrice = "232.00",actPrice, expClaim= "No",actClaim, expDis = "No", actDis, expCover = "No", actCover;
		...
		driver.findElement(By.id("email")).sendKeys("devendrashaha2@gmail.com");
		driver.findElement(By.id("phone")).sendKeys("7020415177");
		driver.findElement(By.id("username")).sendKeys("Dev21");
		driver.findElement(By.id("password")).sendKeys("Test@123");
		driver.findElement(By.id("confirmpassword")).sendKeys("Test@123");
		
		driver.findElement(By.id("sendemail")).click();
		
		System.out.println(driver.findElement(By.xpath("//h2[normalize-space()='Sending e-mail success!']")).getText());
