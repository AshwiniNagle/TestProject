...
public class TC_05TruckSilver {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("engineperformance")).sendKeys("1600");
		driver.findElement(By.id("dateofmanufacture")).sendKeys("02/08/2022");
		...
		driver.findElement(By.id("licenseplatenumber")).sendKeys("KA02AK2561");
		...
		//Enter Insurant Data
				driver.findElement(By.id("firstname")).sendKeys("Makrand");
				driver.findElement(By.id("lastname")).sendKeys("Anaspure");
				driver.findElement(By.id("birthdate")).sendKeys("06/12/1975");
				...
				driver.findElement(By.id("streetaddress")).sendKeys("Sadasiv Peth");
			...
			//Enter Product Data
				...
				driver.findElement(By.id("startdate")).sendKeys("10/04/2023");
			...
			//Select Price Options
				...
				String expPrice = "288.00",actPrice, expClaim= "No",actClaim, expDis = "No", actDis, expCover = "No", actCover;
			...
			//Send Quote
				...
				driver.findElement(By.id("email")).sendKeys("mak123@gmail.com");
				driver.findElement(By.id("phone")).sendKeys("9765394354");
				driver.findElement(By.id("username")).sendKeys("Mac123");
