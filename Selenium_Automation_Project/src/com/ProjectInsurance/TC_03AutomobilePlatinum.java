...
public class TC_03AutomobilePlatinum {
	...
	public static void main(String[] args) {
		...
		//Enter Vehicle Data
				...
				seats.selectByIndex(1);
				
				Select fuel = new Select(driver.findElement(By.id("fuel")));
				fuel.selectByIndex(2);
				
				driver.findElement(By.id("listprice")).sendKeys("2500");
				driver.findElement(By.id("licenseplatenumber")).sendKeys("MH42AK2200");
				driver.findElement(By.id("annualmileage")).sendKeys("3000");
		...
		//Enter Insurant Data
				...
				driver.findElement(By.id("lastname")).sendKeys("Ranaware");
				driver.findElement(By.id("birthdate")).sendKeys("09/12/1995");
				...
				driver.findElement(By.id("streetaddress")).sendKeys("Phaltan Road");
				
				Select country = new Select(driver.findElement(By.id("country")));
				country.selectByValue("India");
				
				driver.findElement(By.id("zipcode")).sendKeys("414102");
				driver.findElement(By.id("city")).sendKeys("Phaltan");
				
				Select occu = new Select(driver.findElement(By.id("occupation")));
				occu.selectByValue("Employee");
				
				driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/section[2]/div[10]/p[1]/label[3]/span[1]")).click();
			...
			//Enter Product Data
				...
				driver.findElement(By.id("startdate")).sendKeys("10/06/2023");
			...
			//Select Price Options
				...
				String expPrice = "1,315.00",actPrice, expClaim= "Submit",actClaim, expDis = "5", actDis, expCover = "Limited", actCover;
			...
			//Send Quote
				...
				driver.findElement(By.id("email")).sendKeys("ashishr@gmail.com");
				driver.findElement(By.id("phone")).sendKeys("9863324147");
				driver.findElement(By.id("username")).sendKeys("Ashish2");
