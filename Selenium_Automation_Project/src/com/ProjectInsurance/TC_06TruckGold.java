...
public class TC_06TruckGold {
	...
	public static void main(String[] args) {
		...
		make.selectByIndex(9);
		driver.findElement(By.id("engineperformance")).sendKeys("1200");
		driver.findElement(By.id("dateofmanufacture")).sendKeys("03/08/2022");
		...
		driver.findElement(By.id("payload")).sendKeys("300");
		driver.findElement(By.id("totalweight")).sendKeys("1200");
		driver.findElement(By.id("listprice")).sendKeys("10000");
		driver.findElement(By.id("licenseplatenumber")).sendKeys("KA02AK2575");
		driver.findElement(By.id("annualmileage")).sendKeys("2200");
		...
		//Enter Insurant Data
				...
				driver.findElement(By.id("birthdate")).sendKeys("05/25/1985");
				...
				driver.findElement(By.id("streetaddress")).sendKeys("KarveNagar Pune");
				
				Select country = new Select(driver.findElement(By.id("country")));
				country.selectByValue("India");
				
				driver.findElement(By.id("zipcode")).sendKeys("411053");
			...
			//Select Price Options
				...
				String expPrice = "802.00",actPrice, expClaim= "Submit",actClaim, expDis = "2", actDis, expCover = "Limited", actCover;
			...
			//Send Quote
				...
				driver.findElement(By.id("email")).sendKeys("anmore1@gmail.com");
				driver.findElement(By.id("phone")).sendKeys("9900653943");
				driver.findElement(By.id("username")).sendKeys("Anm123");
