...
public class TC_07TruckPlatinum {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("dateofmanufacture")).sendKeys("03/05/2022");
		...
		driver.findElement(By.id("payload")).sendKeys("400");
		driver.findElement(By.id("totalweight")).sendKeys("1300");
		driver.findElement(By.id("listprice")).sendKeys("17500");
		driver.findElement(By.id("licenseplatenumber")).sendKeys("MH02AK2575");
		...
		//Enter Insurant Data
				driver.findElement(By.id("firstname")).sendKeys("Avinash");
				driver.findElement(By.id("lastname")).sendKeys("Dhvale");
				driver.findElement(By.id("birthdate")).sendKeys("10/30/1995");
				...
				driver.findElement(By.id("streetaddress")).sendKeys("Mekhali Road");
				
				Select country = new Select(driver.findElement(By.id("country")));
				country.selectByValue("India");
				
				driver.findElement(By.id("zipcode")).sendKeys("413106");
				driver.findElement(By.id("city")).sendKeys("Indapur");
				
				Select occu = new Select(driver.findElement(By.id("occupation")));
				occu.selectByValue("Selfemployed");
				
				driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/section[2]/div[10]/p[1]/label[5]/span[1]")).click();
			...
			//Enter Product Data
				...
				driver.findElement(By.id("startdate")).sendKeys("12/03/2023");
				
				Select insum = new Select(driver.findElement(By.id("insurancesum")));
				insum.selectByValue("7000000");
			...
			//Select Price Options
				...
				String expPrice = "1,705.00",actPrice, expClaim= "Submit",actClaim, expDis = "5", actDis, expCover = "Limited", actCover;
				...
				WebElement opt = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/section[4]/section[1]/div[1]/table[1]/tfoot[1]/tr[1]/th[2]/label[3]/span[1]"));
				opt.click();
			...
			//Send Quote
				...
				driver.findElement(By.id("email")).sendKeys("avin12@gmail.com");
				driver.findElement(By.id("phone")).sendKeys("9906753943");
				driver.findElement(By.id("username")).sendKeys("Avd23");
